        ...
        if (typeof duoshuo_user_ID !== 'undefined') {
            if (e.post.author.user_id && (e.post.author.user_id == duoshuo_user_ID)) {
                if (duoshuo_admin_nickname) {
                    ...
                    isAdmin = '<span class="fa" style="color:red">owner</span>';
                }
            } else {
                isAdmin = '';
            }
...
function showUa(string) {
    ...
    //return br + '<span class="platform ' + sua.os.name + '">' + osIco + '</span>' 
    //     + br +
    //    '<span class="browser ' + sua.browser.name + '">' + browserIco + '</span>';
    return br + '<span class="platform ' + sua.os.name + '" '
          + 'onmouseover="$(this).children(\'span\').css(\'display\',\'inline\');'
          +              '$(this).next().children(\'span\').css(\'display\',\'inline\');" ' 
          //+ 'onMouseOut="$(this).children(\'span\').css(\'display\',\'none\');'
          //+             '$(this).next().children(\'span\').css(\'display\',\'none\');"'
          + '>' 
          + osIco 
          + '<span class="text" style="display: none;">' + sua.os.name + ' ' + sua.os.version + ' ' +'</span>' + '</span>'
          + br
          + '<span class="browser ' + sua.browser.name + '" '
          + 'onmouseover="$(this).children(\'span\').css(\'display\',\'inline\');'
          +               '$(this).prev().children(\'span\').css(\'display\',\'inline\');" '
          //+ 'onMouseOut="$(this).children(\'span\').css(\'display\',\'none\');'
          //+             '$(this).prev().children(\'span\').css(\'display\',\'none\');"' 
          + '>'
          + browserIco 
          + '<span class="browser text" style="display: none;">'+ sua.browser.name + '|' + sua.browser.version + '</span>' +'</span>';
}
